...
export const createRequest = async (req: Request, res: Response): Promise<void> => {
    ...
    try {
        ...
        const normalizedType = (type || 'exchange').toLowerCase() as RequestType;
...
export const getExchangeHistory = async (req: Request, res: Response): Promise<void> => {
...
export const getLogisticsRequests = async (req: Request, res: Response): Promise<void> => {
    const userId = req.user.id;
